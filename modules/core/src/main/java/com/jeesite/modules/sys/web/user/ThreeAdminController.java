 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sys/threeAdmin")
@ConditionalOnProperty(name="web.core.enabled", havingValue="true", matchIfMissing=true)
public class ThreeAdminController extends BaseController {
	...
	@RequiresPermissions("sys:threeAdmin:view")
	@RequestMapping(value = "list")
	public String list(User user, Model model) {
		return "modules/sys/user/threeAdminList";
	}
	...
	public String form(User user, String op, Model model) {
		...
		return "modules/sys/user/threeAdminForm";
	}
	 ...
	 * @return
	 */
	@RequiresPermissions("sys:threeAdmin:edit")
	...
	public String save(@Validated User user, String op) {
		...
		return renderResult(Global.TRUE, text("保存三级管理员''{0}''成功", user.getUserName()));
	}
	...
	public String delete(User user) {
		...
		userService.updateMgrType(user);
		return renderResult(Global.TRUE, text("取消三级管理员''{0}''身份成功", user.getUserName()));
	}
}
