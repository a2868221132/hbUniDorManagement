...
@Table(name="${_prefix}sys_user", alias="a", columns={
		...
		@JoinTable(type=Type.JOIN, entity=Employee.class, alias="e",
			...
			attrName="employee", columns={
				...
				@Column(name="emp_no", 		attrName="empNo", 				label="学生证编号"),
...
public class EmpUser extends User {
	...
	@ExcelFields({
		...
		@ExcelField(title="昵称", attrName="userName", align=Align.CENTER, sort=40),
		...
		@ExcelField(title="电话", attrName="phone", align=Align.CENTER, sort=70),
		...
		@ExcelField(title="姓名", attrName="employee.empName", align=Align.CENTER, sort=95),
