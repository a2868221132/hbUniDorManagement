...
COMMENT ON COLUMN js_sys_employee.emp_name IS '姓名';
COMMENT ON COLUMN js_sys_employee.emp_name_en IS '员工英文名';
COMMENT ON COLUMN js_sys_employee.emp_no IS '学生证编号';
...
COMMENT ON COLUMN js_sys_office.phone IS '电话';
...
COMMENT ON COLUMN js_sys_user.user_name IS '昵称';
...
COMMENT ON COLUMN js_sys_user.phone IS '电话';
